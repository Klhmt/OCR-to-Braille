...
if __name__=="__main__" :
    ...
    for region in os.listdir(source_folder):
        ...
        # image = cv2.imread(f'Test_folder/regions_de_texte/{nom_image}')
        ...
        ranges = separe_en_caracteres(nom_image, (402,487))
        ...
        for elt in ranges :
            ...
            output_path = f'{source_folder}/{region}/caracteres_region/caract{count}.jpg'
            count+=1
